...
export default class extends Base {
  ...
  theDaySubPeriodFlow () {
    ...
    this.vm.lineChart.legendData.length = 0
    BridgeApi.theDaySubPeriodFlow({ bridgeId: BRIDGE_ID }).then(res => {
      if (res.data) {
        ...
        this.vm.lineChart.legendData.push('由北向南')
        ...
        this.vm.lineChart.legendData.push('由南向北')
      ...
      if (res.data) {
        ...
        this.vm.data.push({
          ...
          value: [
            ...
            {
              ageRange: '23-35岁',
              percentage: (res.data[0].cnt_23_35 / res.data[0].total * 100).toFixed(2)
            },
            {
              ageRange: '36-45岁',
